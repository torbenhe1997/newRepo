(function () {
    ...
    class HelloWorld1 extends HTMLElement {
        ...
        setValue(newValue) {
            ...
            this.executeFunction(this._value);
        ...
        executeFunction(arrayValues) {
            ...
            google.charts.setOnLoadCallback(function () {
                drawTable(arrayValues);
            });


            function drawTable(arrayValues) {
                console.log("Value3");
                console.log(arrayValues);
                console.log("bist du es wirklich?")
        ...
        iterator(arrayValues) {




            var test = arrayValues;
